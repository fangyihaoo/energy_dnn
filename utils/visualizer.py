...
# cycD = torch.load('../EnergyDisDNN/log/decay/poissoncyclepoissourmethod.pt', map_location=torch.device('cpu'))
# cycP = torch.load('../EnergyDisDNN/log/decay/poissoncyclepoisspinn.pt', map_location=torch.device('cpu'))
# D = torch.load('../EnergyDisDNN/log/decay/poipoissourmethod.pt', map_location=torch.device('cpu'))
# P = torch.load('../EnergyDisDNN/log/decay/poipoisspinn.pt', map_location=torch.device('cpu'))
...
#     ax[1].set_title(r'$f = \sin{x}\cdot\cos{y}$')
